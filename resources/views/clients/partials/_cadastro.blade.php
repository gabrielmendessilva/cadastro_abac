{{-- Aba CADASTRO (departamentos / comitês / segmento / área de atuação) --}}
<div x-data="{ openComite: false }" class="space-y-6">
    <div>
        <h2 class="text-lg font-semibold text-slate-900">Cadastro</h2>
        <p class="text-sm text-slate-500">Departamentos, comitês, segmento e área de atuação.</p>
    </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5">
        <div class="mb-3 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500">Gerencie pela aba <strong>Contatos</strong> (cada contato pertence a um departamento).</p>
            </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5">
        <div class="mb-3 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500">Comitês em que o cliente participa.</p>
            </div>
            @can('clients.edit')
                        ...
                        <form method="POST" action="{{ route('clients.comites.store', $client) }}">
                            ...
                            <div class="grid grid-cols-1 gap-4 p-6 md:grid-cols-2">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="comite_nome" required class="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm">
                                </div>
                                <div>
