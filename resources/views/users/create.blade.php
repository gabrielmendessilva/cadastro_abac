...
<div class="mb-6 rounded-2xl bg-indigo-50 border border-indigo-100 px-4 py-3 text-sm text-indigo-900">
    Não é preciso definir senha: ao salvar, o sistema gera uma senha temporária e envia
    para o e-mail informado, junto com o endereço de acesso. No primeiro login o próprio
    usuário define a senha definitiva.
</div>
