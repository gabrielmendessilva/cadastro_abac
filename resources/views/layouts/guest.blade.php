...
<head>
    ...
    <title>@yield('title', 'Login - Cadastro ABAC')</title>
...
<body class="min-h-screen bg-slate-950 flex items-center justify-center p-6">
    <div class="w-full max-w-5xl grid lg:grid-cols-2 overflow-hidden rounded-3xl shadow-2xl bg-white">
        <div class="hidden lg:flex bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 text-white p-10 flex-col items-center justify-center text-center">
            <div>
                <h1 class="text-5xl font-bold leading-tight tracking-wide">CADASTRO<br>ABAC</h1>
